...
SWARM_MODELS = {
    # 🌙 Active Models — only models we have API keys for
    "claude": (True, "claude", "claude-sonnet-4-6"),       # Claude Sonnet 4.6 (ANTHROPIC_KEY)
    "deepseek": (True, "deepseek", "deepseek-chat"),       # DeepSeek Chat (DEEPSEEK_KEY)

    # 🔇 Disabled Models — no API keys configured
    #"xai": (True, "xai", "grok-4-fast-reasoning"),        # Needs XAI_API_KEY
    #"openrouter_qwen": (True, "openrouter", "qwen/qwen3-max"),  # Needs OPENROUTER_API_KEY
    #"opus": (True, "claude", "claude-opus-4-5-20251101"), # Too expensive for swarm voting
    #"openai": (True, "openai", "gpt-5"),                  # Needs OPENAI_KEY
    #"ollama_qwen": (True, "ollama", "qwen3:8b"),          # Needs local Ollama
    #"ollama": (True, "ollama", "DeepSeek-R1:latest"),     # Needs local Ollama
